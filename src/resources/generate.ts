...
import { TransportError, UnexpectedApiError, ValidationError, ApiResponseError, BadRequestError, ForbiddenError, PayloadTooLargeError, RateLimitedError, UnauthorizedError, UnprocessableEntityError } from "../errors.js";
...
export class GenerateResource {
   ...
   * `POST /generate`
   */
  async run(body: GenerateRequest, options?: RequestOptions): Promise<ApiResult<GenerationResult, GenerateRunError>> {
    return this._core.request<GenerationResult, GenerateRunError>({
      method: "POST",
      path: "/generate",
      body,
      errors: { "400": BadRequestError, "401": UnauthorizedError, "403": ForbiddenError, "413": PayloadTooLargeError, "422": UnprocessableEntityError, "429": RateLimitedError, default: ApiResponseError },
...
export type GenerateRunError = BadRequestError | UnauthorizedError | ForbiddenError | PayloadTooLargeError | UnprocessableEntityError | RateLimitedError | ApiResponseError | UnexpectedApiError | TransportError | ValidationError;
