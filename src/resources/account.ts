...
import { TransportError, UnexpectedApiError, UnauthorizedError } from "../errors.js";
...
export type AccountWhoamiError = UnauthorizedError | UnexpectedApiError | TransportError;
