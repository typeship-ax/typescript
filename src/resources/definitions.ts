...
import type { Definition, DefinitionId, DefinitionUpdateRequest } from "../types.js";
...
export class DefinitionsResource {
  ...
  ): Promise<ApiResult<Definition, DefinitionsRetrieveError>> {
    return this._core.request<Definition, DefinitionsRetrieveError>({
      method: "GET",
  ...
  async update(
    ...
    options?: RequestOptions,
  ): Promise<ApiResult<Definition, DefinitionsUpdateError>> {
    return this._core.request<Definition, DefinitionsUpdateError>({
      method: "PATCH",
      path: `/definitions/${encodeURIComponent(String(definitionId))}`,
      body,
      errors: {
