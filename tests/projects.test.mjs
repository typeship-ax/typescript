...
test("projects.list GET /projects", async () => {
  const mock = await startMock({ status: 200, contentType: "application/json", body: "{\"data\":[{\"id\":\"example\",\"object\":\"project\",\"name\":\"example\",\"spec_url\":\"example\",\"source\":{\"kind\":\"url\",\"url\":\"example\",\"repo\":\"example\",\"path\":\"example\"},\"destination\":{\"repo\":\"example\",\"directory\":\"example\"},\"auto_regen\":true,\"package_name\":\"example\",\"spec_patches\":[{\"op\":\"set\",\"path\":\"example\",\"value\":{},\"to\":\"example\",\"reason\":\"example\"}],\"cli_config\":{\"whoami_operation\":\"example\",\"oauth_client_id\":\"example\",\"oauth_scopes\":[{}],\"oauth_audience\":\"example\",\"update_notice\":true,\"docs_url\":\"example\",\"support_url\":\"example\",\"mcp_tool_mode\":\"auto\"},\"mcp_url\":\"example\",\"relay_enabled\":true,\"agents_url\":\"example\",\"platform\":\"sdk\",\"created_at\":\"2024-01-01T00:00:00Z\"}]}" });
  try {
...
test("projects.create POST /projects", async () => {
  ...
  try {
    const client = new TypeshipClient({ baseUrl: mock.url, bearerToken: "test-token" });
    const result = await client.projects.create({"name":"example","spec_url":"example"});
    assert.equal(result.ok, true, JSON.stringify(result));
    const request = mock.requests[0];
...
test("projects.generate POST /projects/{project_id}/generations", async () => {
  const mock = await startMock({ status: 201, contentType: "application/json", body: "{\"id\":\"example\",\"object\":\"generation\",\"project_id\":\"example\",\"status\":\"succeeded\",\"trigger\":\"manual\",\"meta\":{\"title\":\"example\",\"version\":\"example\",\"spec_format\":\"openapi\",\"oas_version\":\"example\",\"converted\":true,\"package_name\":\"example\",\"client_name\":\"example\",\"targets\":[\"sdk\"],\"resource_count\":1,\"operation_count\":1,\"schema_count\":1,\"paginated_operation_count\":1,\"omitted_operation_count\":1,\"pr_url\":\"example\",\"pr_number\":1,\"file_count\":1,\"total_lines\":1},\"warnings\":[\"example\"],\"files\":[{\"path\":\"example\",\"content\":\"example\"}],\"error\":\"example\",\"created_at\":\"2024-01-01T00:00:00Z\"}" });
  try {
    const client = new TypeshipClient({ baseUrl: mock.url, bearerToken: "test-token" });
