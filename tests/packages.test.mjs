// typeship — generated smoke tests for the packages resource.
...
test("packages.download GET /generate/download", async () => {
  ...
  try {
    ...
    const result = await client.packages.download({"token":"example"});
    const request = mock.requests[0];
